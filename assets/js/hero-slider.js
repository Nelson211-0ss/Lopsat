(function () {
  ...
  var slides = [
    {
      tag: "Road freight & delivery",
      title: "Container loads, trailers, and dependable road transport",
      desc:
        "Headquartered at Myraid business center, Juba-South Sudan (Airport R, Next to panaroma plaza), we coordinate heavy cargo, container moves, and end-to-end logistics with teams that stay close to your timelines.",
    ...
    },
    {
      ...
      desc:
        "We move cargo by air, road, and sea; clear customs; handle ports and warehousing; and support corporate and residential relocations with the same rigor on every shipment.",
      ctaHref: "logistics.html",
      ctaLabel: "Freight services",
    ...
    },
    {
      ...
      image: "unsplash-1586528116493-a029325540fa.jpg",
    },
  ];
  ...
  /* After images/fonts settle (some hosts delay layout); remount is idempotent. */
